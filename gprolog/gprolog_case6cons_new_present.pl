...
writecasefbinary([FL5,FL4,FL3,FL2,FL1,FL0], [A, B, C, D, E, F]) :-
...
presentallclasses(A) :-
    ...
    write('----------------------------------'), nl,
    write('----------------------------------'), nl,
    write('TOTAL CASES: '), write(N), write('; TOTAL DIFFERENT CASES: '), write(RN), nl, nl.
