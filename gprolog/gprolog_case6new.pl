...
case2fc([c(LenFL1),FL1],A,B,RA,RB) :- 
    case2(FL1,A,B,RA,RB,RA,RB),
    length(FL1,LenFL1).
...
case3fc([c(LenFL2,LenFL1),FL2,FL1],A,B,C,RA,RB,RC) :- 
...
%    u(PermXYZ,X,Y,Z), replacef(S,SP,[X,Y,Z],PermXYZ), 
%    member(S2,Ss), similarcasef(SP,S2), !,
...
case4fc([c(LenFL3,LenFL2,LenFL1),FL3,FL2,FL1],A,B,C,D,RA,RB,RC,RD) :- 
...
%    u(PermWXYZ,W,X,Y,Z), 
%    replacef(S,SP,[W,X,Y,Z],PermWXYZ), 
%    member(S2,Ss), similarcasef(SP,S2), !,
...
case5fc([c(LenFL4,LenFL3,LenFL2,LenFL1),FL4,FL3,FL2,FL1],
...
%    replacef(S,SP,[V,W,X,Y,Z],PermVWXYZ), 
%    member(S2,Ss), similarcasef(SP,S2), !,
...
case6fc([c(LenFL5,LenFL4,LenFL3,LenFL2,LenFL1),FL5,FL4,FL3,FL2,FL1],
...
%    replacef(S,SP,[U,V,W,X,Y,Z],PermUVWXYZ), 
%    member(S2,Ss), similarcasef(SP,S2), !,
